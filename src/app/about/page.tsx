...
const principles = [
  ...
  { icon: ListChecks, title: "Условия по каждой модели", text: "Ставка, залог и заполненные ограничения показаны до оформления." },
