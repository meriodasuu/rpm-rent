...
export const seedCars: Car[] = [
  ...
  car({
    ...
    pricePerDay: 25000,
    deposit: 50000,
    shortDescription: "Премиальное спортивное купе для коротких поездок, выходных и сравнения внутри категории «Спорт».",
    recommendedOrder: 4,
...
export const seedFaqs: Faq[] = [
  { id: "faq-dates", question: "Можно выбрать автомобиль на конкретные даты?", answer: "Да. Укажите начало и окончание аренды на главной странице или в заявке. Каталог исключит подтверждённые пересечения, а система повторно проверит период перед созданием заявки.", category: "booking", published: true, sortOrder: 1 },
  ...
  { id: "faq-deposit", question: "Нужен ли залог?", answer: "Размер залога указан в карточке автомобиля и в сводке заявки. Порядок его внесения и возврата фиксируется в согласованных условиях и договоре.", category: "payment", published: true, sortOrder: 3 },
  { id: "faq-confirm", question: "Заявка сразу подтверждает бронирование?", answer: "Нет. Заявка передаёт выбранный автомобиль, даты и контакты менеджеру. Доступность и итоговые условия подтверждаются отдельно до оформления.", category: "booking", published: true, sortOrder: 4 },
  { id: "faq-pickup", question: "Как получить автомобиль?", answer: "В форме можно выбрать самовывоз или доставку. Для доставки укажите адрес; возможность подачи и применимая стоимость подтверждаются при обработке заявки.", category: "delivery", published: true, sortOrder: 5 },
